...
$jj = $controller->beforeNouUsuariName($nom);
$gg = $controller->beforeNouUsuari($correu);
$a= "Error - Contacta amb un administrador.";
if($gg>0){
    $a= "El correu ja esta en us, prova un altre.";
}else if($jj>0){
    $a= "El nom ja esta en ús, prova un altre.";
}else{
    $a= "Usuari afegit correctament";
    $j = $controller->nouUsuari($nom, $correu);
}
