...
<!-- BARRA SUPERIOR ANCLADA -->
  ...
  <div class="content-wrapper">
    <section class="content-header">
	  <h1>Gestionar Usuaris ➪ Modificar</h1>
    </section>
  <!-- CAIXES BARRA SOTA INICI -->
    <section class="content">
        <form method="post" action="gestionaUsEditar2.php">
        ...
        <form method="post" action="gestionaUsEditarDelete.php"><input type="hidden" name="id" value="<?=$j->getId()?>" /><button type="submit" class="btn btn-primary">Eliminar Usuari</button><a> </a></form>
