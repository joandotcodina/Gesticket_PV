...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Gestió de perfils d'inici de sessió ➪ Afegir</h1>
        </section>
        <!-- CAIXES BARRA SOTA INICI -->
        <section class="content">
            <form method="post" action="afegirusuariLogin2.php">
                ...
                <div class="form-group">
                    <label>Usuari</label>
                    <input type="text" class="form-control"  name="usuari" >
                </div>
                <div class="form-group">
                    <label>Contrasenya</label>
                    <input type="password" class="form-control"  name="clau1" >
                </div>
                <div class="form-group">
                    <label>Repeteix la contrasenya</label>
                    <input type="password" class="form-control"  name="clau2" >
                </div>
                <div class="form-group">
                    <label>Tipus</label>
