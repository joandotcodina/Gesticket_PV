...
$jj = $controller->beforeNouUsuariLogin($usuari);
$a= "Les dues contrasenyes no son iguals!";
if($clau1 == $clau2) {
    if($jj>0){
        $a= "El usuari ja existeix, prova un altre.";
    }else{
        $a= "Usuari afegit correctament";
        $j = $controller->nouUsuariLogin($nom, $correu, $usuari,$clau1,$perfil);
    }
