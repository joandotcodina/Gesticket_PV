...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                <form method="post" action="notificacions2.php">
                    <div class="form-group">
                        <label>Vols rebre notificacions? </label>
                        <select class="form-control select2" style="width: 100%;" name="opcio">
                            <?php if($_SESSION['usuari']['notificacions'] == "Si"){?>
                                <option selected="selected"><?php echo $_SESSION['usuari']['notificacions'] ?></option>
                                <option>No</option>
                            <?php }else{ ?>
                                <option selected="selected"><?php echo $_SESSION['usuari']['notificacions'] ?></option>
                                <option>Si</option>
                    ...
                    <button type="submit" class="btn btn-primary">Guardar</button><p>*Hauràs de tornar a iniciar sessió.
        </section>
    </div>
    <!-- PEU -->
