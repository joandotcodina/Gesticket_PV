            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <?php foreach($j as $def){ ?>
                                    <tr>
                                        <td><div class="btn-group"><a href="eliminaGrup.php?id=<?=$def->getId()?>"><button type="button" class="btn btn-default"><i class="fa fa-fw fa-trash"></i></button></a></div></td>
                                        <td><?=$def->getId()?></td>
                                        <td><?=$def->getGrup()?></td>
                                    </tr>
                                <?php } ?>
                        ...
                        <p></p><a href="afegirGrup.php"><button type="submit" class="btn btn-primary">Afegir grup</button></a>
        </section>
    </div>
    <!-- PEU -->
