...
$g = $controller->getSearchValue($busca,$start_from,$results_per_page);
//var_dump($g);
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <div class="dataTables_paginate paging_simple_numbers" id="example1_paginate">
                            <ul class="pagination"><li class="paginate_button previous disabled" id="example1_previous">
                                ...
                                <?php
                                //var_dump($busca);
                                $row = $controller->getPagesS($busca);
                                //var_dump($row);
                                $total_pages = ceil($row['total'] / $results_per_page); // calculate total pages with results
                                //var_dump($total_pages);

                                for ($i=1; $i<=$total_pages; $i++) {  // print
                                    echo "<li class=\"paginate_button ";
                                    if ($i==$page){
                                        echo "active \"><a href=search.php?page=" . $i . "&cerca=" . $busca . " aria-controls=\"example1\" data-dt-idx=" . $i . " tabindex=\"0\">" . $i . "</a></li>";
                                    }else{
                                        echo "\"><a href=search.php?page=" . $i . "&cerca=" . $busca . " aria-controls=\"example1\" data-dt-idx=" . $i . " tabindex=\"0\">" . $i . "</a></li>";
                                    }
                                };
                                ?>
                <!-- /.box -->
