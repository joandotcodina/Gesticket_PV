...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form method="post" action="deleteTiquetp2.php">
            <h1>Estas segur?</h1>
                <input type="hidden" name="id" value="<?=$id?>" />

            <button type="submit" class="btn btn-primary">Si</button><a> </a></form>
            <br>
            <form action="https://gesticket.tk/main_app/Admin/GestionarTickets/tickets.php">
