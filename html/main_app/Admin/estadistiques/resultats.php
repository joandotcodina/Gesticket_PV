...
<!-- BARRA SUPERIOR ANCLADA -->
  ...
  <div class="content-wrapper">
    <section class="content-header">
	  <h1>Descarrega de resultats</h1>
    </section>
  <!-- CAIXES BARRA SOTA INICI -->
    <section class="content">
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Descarregar en format excel</h3>
            </div>
            <form method="post" action="genExcel.php">
              <div class="box-body">
                <div class="form-group">
                  <label>Introdueix el nom del fitxer</label><p></p>
                        <input type="text" class="form-control" name="nom" >
                </div>
              </div>
              <div class="box-footer">
                  <button type="submit" class="btn btn-success">Descarregar</button></form>
              </div>
