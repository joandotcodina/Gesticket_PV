...
$j = $controller->modificarComentariV2($id,$nom,$preu,$motiu,$comentari,$comhorebra,$nuccorrent);
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <h1>El ticket s'ha actualizat correctament</h1>
            <h1>Rebràs un correu amb tota la informació introduida</h1>
        </section>
    </div>
    <!-- PEU -->
