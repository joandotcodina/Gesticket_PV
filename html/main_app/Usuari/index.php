...
<!-- BARRA SUPERIOR ANCLADA -->
  ...
  <div class="content-wrapper">
    <section class="content-header">
	  <h1>Inici</h1><a href="../exit.php"> Tancar sessió</a>
    ...
    <section class="content">
        <div class="col-lg-6 col-xs-12">
            ...
            <div class="small-box bg-aqua">
                <div class="inner">
                    <h3>Afegir tickets</h3>

                    <p>Per registrar nous tickets.</p>
                </div>
                <div class="icon">
                    <i class="fa fa-copy"></i>
                </div>
                <a href="http://gesticket.tk/main_app/Usuari/ticketafegir.php" class="small-box-footer">
                    Click aqui per anar-hi. <i class="fa fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-6 col-xs-12">
            ...
            <div class="small-box bg-yellow">
                <div class="inner">
                    <h3>Veure l'estat<sup style="font-size: 20px"></sup></h3>

                    <p>Per veure en quin estat es troba el ticket.</p>
                </div>
                <div class="icon">
                    <i class="fa fa-file-text-o"></i>
                </div>
                <a href="http://gesticket.tk/main_app/Usuari/ticketstatus.php" class="small-box-footer">
                    Click aqui per anar-hi. <i class="fa fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
