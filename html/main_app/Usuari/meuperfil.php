  ...
  <!-- CAIXES BARRA SOTA INICI -->
    <section class="content">
		<div class="form-group">
                <label>Nom</label>
            <input type="text" class="form-control" name="nom" value="<?php echo $_SESSION['usuari']['nombres'] ?>" disabled>
        </div>
		<div class="form-group">
                <label>Correu</label>
            <input type="text" class="form-control" name="correu" value="<?php echo $_SESSION['usuari']['correu'] ?>" disabled>
        </div>
		<div class="form-group">
                <label>Tipus d'usuari</label>
                <select class="form-control select2" disabled="disabled" style="width: 100%;">
                  <option >Administrador</option>
                  <option selected="selected">Usuari</option>
                </select>
         </div>
    </section>
	  </div>
