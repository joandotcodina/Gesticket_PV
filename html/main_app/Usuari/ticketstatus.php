...
<!-- BARRA SUPERIOR ANCLADA -->
  ...
  <div class="content-wrapper">
	<section class="content-header">
	  <h1>Veure l'estat del meu ticket</h1>
    </section>
	  
    <section class="content">
		<div class="form-group">
            <form method="post" action="ticketstatus2.php" id="form" onsubmit="return validacio()">
                <label>Numero de tiquet</label>
                <input type="number" step="01" min="1" max="10000000" class="form-control" placeholder="Ex: 265" name="id" id="id"><p></p>
        <input type="submit" class="btn btn-primary"/>
                <p></p>
                <p>*Només podrás modificar el tiquet si el seu estat es: "Falten dades" o "Pendent".</p>
                <p>*Comentaris, sempre en podrás ficar.</p>
            </form>
        </div>
    </section>
  </div>
